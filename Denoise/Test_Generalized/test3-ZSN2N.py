...
threshold = np.std(filtered_matrix) * 2.5
...
plt.title('ZSN2N-DAS',fontsize=28)

plt.imshow(denoised, vmin=-1, vmax=1, cmap="seismic", aspect="auto", extent=[0,len(st_raw),0,30])
