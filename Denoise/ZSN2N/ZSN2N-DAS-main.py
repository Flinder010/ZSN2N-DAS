...
ax[0].imshow(matrix, vmin=-40, vmax=40, cmap="seismic", aspect="auto", extent=[0,len(st_raw),1,0])
ax[0].set_xticks([])
ax[0].set_yticks([])
ax[0].set_title('Noised Image')

ax[1].imshow(denoised_return, vmin=-40, vmax=40, cmap="seismic", aspect="auto", extent=[0,len(st_raw),1,0])
ax[1].set_xticks([])
ax[1].set_yticks([])
