...
axs[0].plot(np.arange(0, 1000)/1000, denoised_matrix[:,channel_no], color='k', linewidth=2)
...
f, t, Sxx = scipy.signal.spectrogram(np.pad(denoised_matrix[:,channel_no], (50,50), "constant"), fs=1000, window = scipy.signal.windows.hamming(101), noverlap=100, nfft=1024, scaling='spectrum')
