...
ax.add_patch(rect1)
ax.add_patch(rect2)
ax.legend(handles=[Patch(facecolor='none', edgecolor='r', linewidth=2,label='Ten times of average SNR = ' + '{:.4f}'.format(10*np.mean(SNR_loacl[305:400, 100:650]))),
                   Patch(facecolor='none', edgecolor='m', linewidth=2,label='Ten times of average SNR = ' + '{:.4f}'.format(10*np.mean(SNR_loacl[450:545, 100:650])))], 
                   prop={'size': 20})
