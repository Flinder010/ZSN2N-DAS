...
denoised_matrix = cv2.blur(st_raw_array_resize, (5, 5)) #(5, 5) represents the size of the filter and 0 indicates that the standard deviation should be automatically calculated based on the filter size.
tensor_matrix = torch.tensor(denoised_matrix)
 
plt.rcParams["figure.figsize"] = (20, 6)  
 
channel_no = 365
arrival1 = 353/1000 # Arrival time in sec
arrival2 = 546/1000 # Arrival time in sec
...
ax.set_title("(c) Mean Filtering(5×5)", fontsize=24)  
