...
plt.rcParams["figure.figsize"] = (20,6) # Smaller fig size to make notebook size smaller
...
ax.plot(np.arange(0, 1000) / 1000, denoised_return[:, channel_no], color='k', linewidth=2)
...
ax.set_title("(f) ZSN2N-DAS", fontsize=24)  
plt.show()