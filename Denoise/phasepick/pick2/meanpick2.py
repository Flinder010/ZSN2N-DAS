...
denoised_matrix = cv2.blur(matrix, (5, 5), 0) #(5, 5) represents the size of the filter and 0 indicates that the standard deviation should be automatically calculated based on the filter size.
